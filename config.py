...
def args_parser():
    ...
    parser.add_argument('--num_workers', type=int, default=2, help="number of users: N")
    parser.add_argument('--E', type=int, default=1, help="the number of local updates: E")
    parser.add_argument('--batch_size', type=int, default=3, help="local batch size: B")
    parser.add_argument('--lr', type=float, default=0.01, help="learning rate")
    parser.add_argument('--weight_decay', type=float, default=0.001, help="weight decay")
    parser.add_argument('--step_size', type=int, default=100, help="step size")
    parser.add_argument('--gamma', type=float, default=0.9, help="gamma")
    parser.add_argument('--dropout', type=float, default=0.2, help="drop out")
    ...
    parser.add_argument('--datadir', type=str, default="/home/jxu8/Code/federated_learning_jx/federated_learning/TUDataset")
    ...
    parser.add_argument('--num_round', type=int, default=100, help='number of round')
