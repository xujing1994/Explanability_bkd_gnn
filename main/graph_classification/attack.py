...
if __name__ == '__main__':
    ...
    train_data, test_data, avg_nodes = split_data(dataset, args)
    ...
    for epoch in range(params['epochs']):
        ...
        if not args.filename == "":
            save_path = os.path.join(args.filename, config['model'] + '_' + args.dataset + '_%.2f_%.2f_%.2f.txt'\
                %(args.frac_of_avg, args.poisoning_intensity, args.density))
